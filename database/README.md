...
(http://godoc.org/github.com/tinhnguyenhn/colxd/database)
...
(https://github.com/tinhnguyenhn/colxd/tree/master/docs/json_rpc_api.md).
...
```bash
$ go get -u github.com/tinhnguyenhn/colxd/database
```

## Examples

* [Basic Usage Example]
  (http://godoc.org/github.com/tinhnguyenhn/colxd/database#example-package--BasicUsage)  
  Demonstrates creating a new database and using a managed read-write
  transaction to store and retrieve metadata.

* [Block Storage and Retrieval Example]
  (http://godoc.org/github.com/tinhnguyenhn/colxd/database#example-package--BlockStorageAndRetrieval)  
